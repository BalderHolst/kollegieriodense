...
async function getData(){
	const response = await fetch('https://raw.githubusercontent.com/Baldur2011/Kollegier/main/json/out.json');
...
function createCard(n,obj){
	 ...
	 space.innerHTML = formatIfRange(obj.dorms.space,"m<sup>2</sup>")
	...
	cost.innerHTML = formatIfRange(obj.dorms.cost,"kr");
